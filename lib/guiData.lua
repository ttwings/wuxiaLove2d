...
-- ["时间"]={visible=true,type="txt",x=500,y=0,contant="虎年 十二月 十日 子时 晴朗",color=nil},
    ["对话1"] = { visible = false, type = "dialog", x = 400, y = 160, width = 480, height = 100, alpha = 64, contant = "对话测试文本这是一段长文本的对话测试", color = "WHITE", image = nil },
    ["对话2"] = { visible = false, type = "dialog", x = 400, y = 280, width = 480, height = 100, alpha = 64, contant = "对话测试文本这是一段长文本的对话测试", color = "WHITE", image = nil },
    ...
    ["信息"] = { visible = true, title = "讯息", type = "message", x = 8, y = 400, width = 280, height = 340, alpha = 64, contant = {}, color = nil },
